...
const MapComponent: React.FC<MapProps> = ({
            ...
            try {
                ...
                if (mapRef.current && isInitialized) {
                    ...
                    if (mapRef.current.getSource(sourceId)) {
                        ...
                        const layers = mapRef.current.getStyle().layers?.filter(layer => 'source' in layer && layer.source === sourceId) || [];
    ...
    }, [geometryColumnName, selectedTable, dbContext, fitMapToData, isInitialized]);
    ...
    const updateMapLayers = useCallback(
        ...
        [selectedTable, tables, geometryColumnName, tableStyles, onTableStyleChanged, extraStyle, onExtraStyleChange, fitMapToData]
    );
    ...
    const handleStyleChange = useCallback(
        async (newStyle: maplibregl.StyleSpecification) => {
            ...
            try {
                ...
                const isDefaultStyle = newStyle.sources?.osm && newStyle.layers?.some(layer => layer.id === 'osm-layer');
