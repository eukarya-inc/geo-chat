            ...
            <div ref={chartRef}>
                ...
                >
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '12px' }}>
                        {/* Table Selection */}
                        <div>
                            <label style={{ display: 'block', marginBottom: '4px', fontSize: '0.85em', fontWeight: 'bold' }}>Table:</label>
                            <select
                        ...
                        {/* Chart Type */}
                        <div>
                            <label style={{ display: 'block', marginBottom: '4px', fontSize: '0.85em', fontWeight: 'bold' }}>Chart Type:</label>
                            <select
                    ...
                    {columns.length > 0 && (
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '12px' }}>
                            ...
                            {/* Y Field */}
                            {(['scatter', 'line', 'heatmap', 'box'].includes(config.plotType) || ['bar', 'pie'].includes(config.plotType)) && (
                                <div>
                                    <label style={{ display: 'block', marginBottom: '4px', fontSize: '0.85em', fontWeight: 'bold' }}>
                    ...
                    {columns.length > 0 && (
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 2fr', gap: '12px' }}>
                            ...
                            {['scatter', 'line', 'bar'].includes(config.plotType) && (
                                <div>
                                    <label style={{ display: 'block', marginBottom: '4px', fontSize: '0.85em', fontWeight: 'bold' }}>Color (opt):</label>
                                    <select
                            ...
                            {config.plotType === 'scatter' && (
                                <div>
                                    <label style={{ display: 'block', marginBottom: '4px', fontSize: '0.85em', fontWeight: 'bold' }}>Size (opt):</label>
                                    <select
                            ...
                            {/* Title */}
                            <div>
                                <label style={{ display: 'block', marginBottom: '4px', fontSize: '0.85em', fontWeight: 'bold' }}>Title:</label>
                                <input
                                    type="text"
    ...
    return (
        ...
        >
            ...
            {showHeader && (
                ...
                >
                    <div style={{ fontSize: '0.9em', fontWeight: 'bold', color: '#495057' }}>{String(config.title) || 'Interactive Chart'}</div>
                    <button
