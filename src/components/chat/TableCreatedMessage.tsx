...
export const TableCreatedMessage: React.FC<TableCreatedMessageProps> = React.memo(({ tableName, isSelected, onClick }) => {
    return (
        <div
            className={`
        ...
        >
            {isSelected ? <CheckCircleIcon className="w-5 h-5 flex-shrink-0" /> : <TableCellsIcon className="w-5 h-5 flex-shrink-0" />}
