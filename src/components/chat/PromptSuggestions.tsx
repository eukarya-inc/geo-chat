...
export const PromptSuggestions: React.FC<PromptSuggestionsProps> = ({ prompts, onPromptClick, title, className = '' }) => {
    ...
    return (
        <div className={`mt-4 ${className}`}>
            {title && <div className="text-xs text-gray-600 mb-2 font-medium">{title}</div>}
            <div
