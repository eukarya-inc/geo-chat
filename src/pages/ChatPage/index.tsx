...
function ChatPage() {
    ...
    const { chats, selectedChatId, createNewChat, deleteChat, selectChat, updateChatMessages, getCurrentChatState } = useChatManagement(dbContext);
    ...
    // Message handling
    const { sendMessageRef, handleSendMessageReady, handleMessagesChange } = useMessageHandling(selectedChatId, updateChatMessages);
                ...
                {selectedDashboardId ? (
                    ...
                    <>
                        ...
                        <div className="w-1/2 h-full border-r border-gray-300 flex flex-col overflow-hidden">
                                    ...
                                    <div className="flex gap-2.5 items-center">
                                        ...
                                        <button
                                            ...
                                            className={`px-4 py-2 text-white border-none rounded text-sm ${
                                                apiKey.trim() ? 'bg-blue-500 cursor-pointer hover:bg-blue-600' : 'bg-gray-400 cursor-not-allowed'
                                            }`}
                                        >
                                            Save
                                        </button>
                            ...
                            {isLoadingApiKey && <div className="p-5 text-center text-gray-600">APIキーを読み込み中...</div>}
                        ...
                        <div className="w-1/2 h-full flex flex-col overflow-hidden">
                            <div className="flex-1 overflow-hidden flex flex-col">
                                        ...
                                        <div className="flex-1 overflow-hidden">
                                            ...
                                            {activeTab === 'sql' && (
                                                <div className="h-full p-4 overflow-auto">
                                                    <TableSQLDisplay tableName={selectedTable} dbContext={dbContext} schema={schemaName} />
                                                </div>
                                            )}
                                                                    ...
                                                                    {chartSpec && (
                                                                        <ChartConfigForm
                                                                            ...
                                                                            onSave={() => {
                                                                                ...
                                                                                const chartElement =
                                                                                    document.querySelector('.vega-embed canvas, .vega-embed svg');
                                ...
                                {dbContext && !selectedTable && (
                                    <div className="flex items-center justify-center h-full text-gray-500">テーブルを選択してください</div>
                                )}
                            </div>
                        </div>
                        {/* End of Right Half */}
